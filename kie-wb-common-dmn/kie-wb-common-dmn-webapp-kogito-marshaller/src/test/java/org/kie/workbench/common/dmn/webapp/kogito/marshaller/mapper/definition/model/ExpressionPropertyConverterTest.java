...
public class ExpressionPropertyConverterTest {
    ...
    private void assertWBFromDMNConversion(final JSITExpression dmn,
                                           final Class wbClass) {
        final JSITDMNElement parent = new JSITDMNElement();
        final Expression wb = ExpressionPropertyConverter.wbFromDMN(dmn, parent, hasComponentWidthsConsumer);
    ...
    private void assertDMNFromWBConversion(final Expression wb,
        ...
        final JSITExpression dmn = ExpressionPropertyConverter.dmnFromWB(wb, componentWidthsConsumer);
        ...
        final JsArrayLike<Float> widths = componentWidths.getWidth();
        assertThat(widths.getLength()).isEqualTo(wb.getRequiredComponentWidthCount());
        assertThat(widths.getLength()).isEqualTo(expectedComponentWidths.length);

        IntStream.range(0, expectedComponentWidths.length).forEach(i -> assertThat(widths.getAt(i)).isEqualTo(expectedComponentWidths[i]));
    }
    ...
    public void testDMNFromWB_ContextConversion() {
        ...
        assertDMNFromWBConversion(wb, JSITContext.class, 100.0, 200.0, 300.0);
    }
    ...
    public void testDMNFromWB_RelationConversion() {
        ...
        assertDMNFromWBConversion(wb, JSITRelation.class, 200.0);
    }
    ...
    public void testDMNFromWB_ListConversion() {
        ...
        assertDMNFromWBConversion(wb, JSITList.class, 200.0);
    }

    @Test
    public void testWBFromDMN_InvocationConversion() {
        final JSITInvocation dmn = new JSITInvocation();
        dmn.setId(EXPRESSION_UUID);
    ...
    public void testDMNFromWB_InvocationConversion() {
        ...
        assertDMNFromWBConversion(wb, JSITInvocation.class, 100.0, 200.0, 300.0);
    }
    ...
    public void testDMNFromWB_FunctionDefinitionConversion() {
        ...
        assertDMNFromWBConversion(wb, JSITFunctionDefinition.class, 100.0, 200.0);
    }

    @Test
    public void testWBFromDMN_DecisionTableConversion() {
        final JSITDecisionTable dmn = new JSITDecisionTable();
        dmn.setId(EXPRESSION_UUID);
    ...
    public void testDMNFromWB_DecisionTableConversion() {
        ...
        assertDMNFromWBConversion(wb, JSITDecisionTable.class, 100.0, 200.0);
    }
}
