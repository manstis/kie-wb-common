...
public class InvocationPropertyConverterTest {
    ...
    public void testWBFromDMN() {
        ...
        dmn.setTypeRef(INVOCATION_QNAME_LOCALPART);
    ...
    public void testDMNFromWB() {
        ...
        final JSITInvocation dmn = InvocationPropertyConverter.dmnFromWB(wb, componentWidthsConsumer);
        ...
        assertThat(dmn.getTypeRef()).isEqualTo(INVOCATION_QNAME_LOCALPART);
