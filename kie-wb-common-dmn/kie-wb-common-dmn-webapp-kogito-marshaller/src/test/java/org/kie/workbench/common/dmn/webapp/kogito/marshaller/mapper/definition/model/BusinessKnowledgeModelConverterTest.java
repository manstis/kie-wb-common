...
public class BusinessKnowledgeModelConverterTest {
    ...
    public void testWBFromDMN() {
        ...
        final JSITBusinessKnowledgeModel dmn = new JSITBusinessKnowledgeModel();
        ...
        final JSITFunctionDefinition functionDefinition = new JSITFunctionDefinition();
    ...
    public void testDMNFromWB() {
        ...
        final JSITBusinessKnowledgeModel dmn = converter.dmnFromNode(node, componentWidthsConsumer);
        ...
        final JSITComponentWidths componentWidths0 = componentWidths.get(0);
        assertThat(componentWidths0.getDmnElementRef()).isEqualTo(EXPRESSION_UUID);
        assertThat(componentWidths0.getWidth().getLength()).isEqualTo(literalExpression.getRequiredComponentWidthCount());
        assertThat(componentWidths0.getWidth().getAt(0)).isEqualTo(200.0);

        final JSITComponentWidths componentWidths1 = componentWidths.get(1);
        assertThat(componentWidths1.getDmnElementRef()).isEqualTo(FUNCTION_DEFINITION_UUID);
        assertThat(componentWidths1.getWidth().getLength()).isEqualTo(functionDefinition.getRequiredComponentWidthCount());
        assertThat(componentWidths1.getWidth().getAt(0)).isEqualTo(200.0);
    }
}
